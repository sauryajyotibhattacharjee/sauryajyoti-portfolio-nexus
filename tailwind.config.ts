	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { 
						boxShadow: '0 0 5px rgba(21, 128, 61, 0.5)',
						borderColor: 'rgba(21, 128, 61, 0.5)'
					},
					'50%': { 
						boxShadow: '0 0 15px rgba(21, 128, 61, 0.8)',
